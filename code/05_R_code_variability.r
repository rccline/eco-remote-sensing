...
library(here)
library(raster)
library(RStoolbox) # classification, viewing & variablity calculation
...
### Visit viridis on cran to see the different color scales.  
...
sen <- brick(here("lab/data/sentinel.png"))
